...
print(getwd())
GDP<-read.csv(paste(dir,"/../data/GDP.csv",sep=""),stringsAsFactors=FALSE, header=FALSE)
EDDATA<-read.csv(paste(dir,"/../data/EDSTATS.csv",sep=""),stringsAsFactors=FALSE, header=TRUE, na.strings=c(""))
