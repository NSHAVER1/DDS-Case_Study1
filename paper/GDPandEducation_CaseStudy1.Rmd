...
Q4. Plotting the GDP for all countries, coloring by Income Group, we note that xxxxxxxxx.
```{r cars5, echo=TRUE}
getwd()
```
...
QuantIncTable <- spread(QuantIncTable,Var2,Freq)
QuantIncTable

```

## Conclusion
In this study of GDP and Education levels, using data from the world bank, we find that there are 189 countries from which we can make conclusions about the GDP and education levels. The country with the 13th lowest GDP is St. Kitts and Nevis. The High.Income:nonOCED groups have an average ranking of 91.91, while the High.Income:OECD groups have an average ranking of 32.97. Thus, within a given income group, being a member of the OCED leads to lower ranking (and thus higher GDP). Of the 38 countries with the highest GDP, five of the are classified as "Lower Middle Income".
