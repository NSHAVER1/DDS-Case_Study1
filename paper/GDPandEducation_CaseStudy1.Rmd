...
getwd()
```
5. Breaking the GDP ranking into 5 separate quantile groups, and then summarizing the Income Groups, we see, as shown in the table below, that 53 countries are in the "Lower Middle Income" Group but among the 38 nations with the highest GDP.
```{r question 5}

#as.table(tapply(gdpGroups$GDP.ranking,gdpGroups$Income.Group,quantile))
tableOfGroups
